...
\lstset{language=C++,
        ...
        stringstyle=\color{mydarkred}\rmfamily,
        xleftmargin=1em,
        showstringspaces=false,
        commentstyle=\itshape\rmfamily\color{mygray},
        columns=flexible,
        keepspaces=true,
        texcl=true,
        morekeywords={alignas,alignof,char16_t,char32_t,concept,constexpr,decltype,noexcept,nullptr,requires,static_assert,thread_local},
        literate={
          {Allocator}{\concept{Allocator}}{9}
          {BidirectionalIterator}{\concept{BidirectionalIterator}}{21}
          {BinaryPredicate}{\concept{BinaryPredicate}}{15}
          {Compare}{\concept{Compare}}{7}
          {Container}{\concept{Container}}{9}
          ...
          {ForwardIterator}{\concept{ForwardIterator}}{15}
          {InputIterator}{\concept{InputIterator}}{13}
          {Iterator}{\concept{Iterator}}{8}
          {MoveConstructible}{\concept{MoveConstructible}}{17}
          {OutputIterator}{\concept{OutputIterator}}{14}
          {RandomAccessIterator}{\concept{RandomAccessIterator}}{20}
        }
}
